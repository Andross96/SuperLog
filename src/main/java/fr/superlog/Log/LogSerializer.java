...
public class LogSerializer {
    ...
    protected LogEvent getLogEvent(){ return logEvent; }
    ...
    protected boolean isAnIgnoredEvent(String condition, String fieldName) {
        if(condition != null) condition = condition.toUpperCase();
    ...
    protected boolean serializeFields(final Event e) {
        Field[] fields = logEvent.getFields();
        ...
        for(Field f : fields){
            ...
            if (o instanceof String) replace("{" + fieldName + "}", (String)o);
                ...
                try {
                    ...
                    if(!list.isEmpty()) {
                        if (list.get(0) instanceof ItemStack) { // List of ItemStack
                            List<ItemStack> itemList = (List<ItemStack>) o;
                ...
                try {
                    Map<Enchantment, Integer> enchants = (Map<Enchantment, Integer>)o;
