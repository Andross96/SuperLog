...
public final class LogEvent {
    ...
    public final Set<String> getConditions(final String condition){ return conditions.get(condition); }
    public final String getDefaultMessage(){ return defaultMessage; }
    public final Field[] getFields(){ return fields; }
    public final boolean isVersionBiggerThan1_13(){ return versionBiggerThan1_13; }
}
